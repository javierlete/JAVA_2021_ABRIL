...
public class RolesRestServlet extends HttpServlet {
	...
	/**
	 * Este m�todo obtiene del Path el id que contiene
	 * @param request la request que contiene el path
	 * @return si no hay path <code>null</code>, si hay path pero no es correcto <code>0L</code> y si hay un valor num�rico ese valor num�rico
	 */
